...
<!-- 	        <header class="bar bar-nav">
            <a class="icon icon-left pull-left back" href="#page1" data-transition='slide-out'></a>
            <a class="button button-link button-nav pull-left close-btn" href="##" data-transition='slide-out'>关闭</a>
            <h1 class="title">投资人图谱</h1>
        </header> -->
        <div class="content">
        	<div class="main-box" >
		...
		<div class="btnBox">
    		<a class="moreProject"  onclick="gotoActivity('1');" href="javascript:window.open('FaS');"></a>
		</div>
</nav>    
</div>
</body>
...
<script type="text/javascript">
 ...
 var userId="${userId}";
 console.log(userId);
 var url="PtlShow!getIrms.action";
 var Obj1=new DataSet();
 Obj1.type="tzr";
 Obj1.contentHeightAuto();
 Obj1.initialiseChart(url,Obj1,userId);
